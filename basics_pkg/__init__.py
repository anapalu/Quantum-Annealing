import sys
sys.path.append('/home/ana/Documents/PhD/my-projects/basics_pkg')

sys.path.append('/home/ana/Documents/PhD/my-projects/basics_pkg/stubs') ### For some reason importing the .pyi files does not fix the alarm 
...
from basics_pauli import Sigma, rotation_spins
